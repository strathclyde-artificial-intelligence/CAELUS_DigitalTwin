...
private:
    ...
    float noise_Gyo = 0.005f;
    float noise_Mag = 0.05f;
...
public:
    ...
    mavlink_message_t hil_state_quaternion_msg(uint8_t system_id, uint8_t component_id) {
        ...
        return this->_hil_state_quaternion_msg(
            ...
            // TODO: USE VAIRALBE for INITIAL_ALT = 2600
            // lat_lon_alt.altitude_mm - 2600,
...
assert(gps_data.vehicle_yaw <= 365 && gps_data.vehicle_yaw > 0);
#endif
