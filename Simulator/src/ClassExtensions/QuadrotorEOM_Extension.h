...
#include <EquationsOfMotion/QuadrotorEOM.h>
#include "../Containers/DroneConfig.h"

class QuadrotorEOM : public caelus_fdm::QuadrotorEOM {
public:
    QuadrotorEOM(DroneConfig conf) : caelus_fdm::QuadrotorEOM(
        conf.b,
        conf.d,
        conf.l,
        NULL,
...
#endif // __QUADROTOREOM_EXTENSION_H__