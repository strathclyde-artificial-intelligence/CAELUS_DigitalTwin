...
class DroneCommander():
    ...
    def commands_from_waypoints(waypoints: Tuple[float, float], altitude: float):
        return list(map(lambda wp: Command(0,0,0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 1, 0, 0, 0, 0, wp[1], wp[0], altitude), waypoints))
    ...
    def mission_from_waypoints(waypoints: Tuple[float, float], altitude: float):
        ...
        commands.insert(0,Command(0,0,0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_TAKEOFF, 0, 1, 0, 0, 0, 0, waypoints[0][1], waypoints[0][0], altitude))
